function getParameterByName(e,t){t=t||window.location.href,e=e.replace(/[\[\]]/g,"\\$&");var a=new RegExp("[?&]"+e+"(=([^&#]*)|&|#|$)").exec(t);return a?a[2]?decodeURIComponent(a[2].replace(/\+/g," ")):"":null}$("body").ready(function(){$("input[type='tel']").bind("change keyup input click",function(){this.value.match(/[^0-9+]/g)&&(this.value=this.value.replace(/[^0-9+]/g,""))})}),$(document).on("submit","#request_form, #presentation_form, #tasting_form, #call_form",function(e){return $.ajax({type:"POST",url:"https://911office.ru/request",data:{formName:$(this).data("name"),name:$("#name").val(),phone:$("#tel").val(),utm_source:getParameterByName("utm_source"),utm_term:getParameterByName("utm_term")},dataType:"JSON",beforeSend:function(){yaCounter49624201.reachGoal("ordersent"),ga("send","ordersent","order"),$(this).attr("disabled","disabled")},success:function(e){console.log(e),$(this).removeAttr("disabled"),$("input").val();var t=$.fancybox.getInstance();t&&(t.close(),$.fancybox.open({src:"#success-modal",type:"inline"}))}}),e.preventDefault(),!1});
