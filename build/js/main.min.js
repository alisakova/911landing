$("body").ready(function(){$("#request_form input[type='tel']").bind("change keyup input click",function(){this.value.match(/[^0-9+]/g)&&(this.value=this.value.replace(/[^0-9+]/g,""))})});var forms=document.querySelectorAll(".form");forms.forEach(function(e){e.addEventListener("submit",function(e){var n=$.fancybox.getInstance();e.preventDefault(),n&&(n.close(),$.fancybox.open({src:"#success-modal",type:"inline"}))})});
...
$(document).ready(function(){$(".reviews-slider").slick({infinite:!0,arrows:!1,autoplay:!0,speed:500,centerPadding:"382px",centerMode:!0,responsive:[{breakpoint:1330,settings:{centerPadding:"250px"}},{breakpoint:992,settings:{centerPadding:"150px"}},{breakpoint:768,settings:{centerPadding:"100px"}},{breakpoint:640,settings:{autoplay:!1,centerMode:!1,adaptiveHeight:!0}}]}),$(".coffee-slider").slick({infinite:!0,arrows:!1,autoplay:!0,speed:500,centerPadding:"440px",centerMode:!0,responsive:[{breakpoint:1500,settings:{centerPadding:"250px"}},{breakpoint:992,settings:{centerPadding:"150px"}},{breakpoint:768,settings:{centerPadding:"100px"}},{breakpoint:640,settings:{autoplay:!1,centerMode:!1}}]})}),$(window).resize(function(){$(".reviews-slider").slick("resize"),$(".coffee-slider").slick("resize")});var scrollAnimation,toTopBtn=document.querySelector(".btn-up");if(toTopBtn){function scrollFunction(){20<document.body.scrollTop||20<document.documentElement.scrollTop?toTopBtn.classList.add("active"):toTopBtn.classList.remove("active")}function scrollToTop(){var e=document.body.scrollTop||document.documentElement.scrollTop;e?(window.scrollBy(0,-Math.max(10,Math.floor(e/10))),scrollAnimation=setTimeout("scrollToTop()",10)):clearTimeout(scrollAnimation)}window.onscroll=function(){scrollFunction()}}
...
function videoPlay(e){var o=e.find(".video__frame"),t=o.data("src");e.addClass("active"),o.attr("src",t)}$(document).on("click",".video__btn",function(e){e.preventDefault(),videoPlay($(this).closest(".video__container"))}),document.querySelector(".video__frame").contentWindow.document.body.onclick=function(){$(".video__container").addClass("active");var e=$(".video__frame").data("src");$(".video__frame").attr("src",e)};