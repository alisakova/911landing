...
function videoPlay(e){var a=e.find(".video__frame"),t=a.data("src");e.addClass("active"),a.attr("src",t)}$(document).on("click",".video__btn",function(e){e.preventDefault();var a=$(this).closest(".video__container");a.hasClass("active")||videoPlay(a)}),document.querySelector(".video__frame").contentWindow.document.body.onclick=function(){$(".video__container").addClass("active");var e=$(".video__frame").data("src");$(".video__frame").attr("src",e)};